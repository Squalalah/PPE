...
<div class="element" style="border-right-style: none;">
    			<div class="div-logreg">
    				...
    				<form action="#" method="POST">
    					...
    					<label for="ins-password">Mot de passe : </label><input type="password" title="ins" name="ins-password" placeholder="Mot de passe choisi" required /><br />
    					<label for="insc-password">Confirmer mot de passe : </label><input type="password" title="ins" name="insc-password" required /><br />
